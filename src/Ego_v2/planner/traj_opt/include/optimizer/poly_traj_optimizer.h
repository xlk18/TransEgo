...
namespace ego_planner
{
  ...
  private:
    ...
    visualization_msgs::MarkerArrayConstPtr pred_trajs_;
    double wei_dyn_obs_;
    void predTrajCallback(const visualization_msgs::MarkerArrayConstPtr &msg) { pred_trajs_ = msg; }
    bool dynObstacleGradCostP(const double t, const Eigen::Vector3d &p, Eigen::Vector3d &gradp, double &costp);
